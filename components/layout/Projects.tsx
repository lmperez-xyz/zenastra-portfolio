        ...
        <div className="p-5 flex flex-col items-center justify-center">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <Link className="block" href="/locaiPage">
                    <Card className="saturate-[0.2] grayscale brightness-75 hover:grayscale-0 hover:saturate-100 hover:scale-101 hover:ring-zinc-600 transition-transform hover:shadow-[0_0_25px_rgba(255,255,255,0.2)] duration-200 relative overflow-hidden h-64 border flex items-center justify-center">
                ...
                <Link className="block" href="/xifizenPage">
                    <Card className="saturate-[0.2] grayscale brightness-75 hover:grayscale-0 hover:saturate-100 hover:scale-101 transition-transform hover:shadow-[0_0_25px_rgba(255,255,255,0.2)] duration-200 relative overflow-hidden h-64 border flex items-center justify-center">
                        <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-transparent to-transparent opacity-100 z-10"/>
