...
export default function Contact() {
    return (
        <div className="min-h-screen bg-black text-white">
            ...
            <div className="flex justify-center px-4 py-30">
                ...
                <Card className="md:translate-x-25 w-full p-6 flex flex-col items-center justify-center gap-3">
                    <h1 className="text-4xl font-bold mb-4">Say Hi</h1>
                    <Input className="p-5 dark:bg-black/70" placeholder="Your Name"></Input>
                    <Input className="p-5 dark:bg-black/70" placeholder="Your Email"></Input>
                    <Textarea className="p-5 dark:bg-black/70" placeholder="Your Message"></Textarea>
                    <Button className="cursor-pointer mt-4 px-6 rounded-full">Send</Button>
                </Card>
