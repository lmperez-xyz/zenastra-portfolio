...
export default function Contact() {
    return (
        <>  
        <Navbar></Navbar>
        <div className="grid grid-cols-2 flex-1 items-center justify-center bg-zinc-50 font-sans dark:bg-black m-10">

            <div className="p-6 w-full max-w-md flex flex-col items-start justify-items-start gap-3">
                <Link href="https://www.linkedin.com/in/lm-perez/"><Button variant="link">
            ...
            <Card className="p-6 w-full max-w-md flex flex-col items-center justify-center">
                ...
                <Button className="mt-4 px-6 rounded-full">Send</Button>
            </Card>
        </div>
        </>
    )
